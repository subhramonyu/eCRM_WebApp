...
public class SessionDeleteTests3550 
{
	...
	@BeforeClass(alwaysRun = true, groups = {FCCM3550.SESSION_DELETE_TESTS})
	public void initClass() throws Exception, ParseException
	{
		...
		{
			FCCM3550.sessionStartTimestampValue = FCCMUtils.getSessionVariableValue(Config.FCCM_PROPERTIES_FILE_PATH, FCCM3550.androidCompletedSessionStartTimestamp, FCCM3550.iOSCompletedSessionStartTimestamp);
	...
	@Test(priority = 130703, groups = {FCCM3550.SESSION_DELETE_TESTS})
